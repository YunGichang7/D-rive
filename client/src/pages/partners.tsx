...
export default function Partners() {
  const partners = [
    {
      ...
      description:
        "차량 관리 시스템 분야의 선도 기업으로 EMS(Energy Management System) 기술을 통한 협업",
      image:
        "https://images.unsplash.com/photo-1558618666-fcd43c7cd028?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
    },
    {
      name: "한국도로교통공단",
      category: "정부 기관",
      ...
      description:
        "교통안전 및 운전자 교육 분야의 전문 기관으로 안전운전 문화 확산을 위한 파트너십",
      image:
    ...
    },
    {
      ...
      description:
        "스타트업 육성과 혁신 생태계 조성을 통한 창업 지원 및 비즈니스 성장 동반자",
      image:
    ...
    },
    {
      ...
      color: "bg-[var(--drive-primary)]",
      description:
        "산학협력을 통한 연구개발 및 인재 양성, 기술 혁신을 위한 학술적 파트너십",
      image:
        "https://images.unsplash.com/photo-1523050854058-8df90110c9d1?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
    },
    {
      name: "부산대학교 창업지원단",
      category: "창업 지원",
      ...
      color: "bg-[var(--drive-secondary)]",
      description:
        "창업 초기 단계부터 성장까지 전 과정을 지원하는 창업 생태계의 핵심 파트너",
      image:
    ...
    },
    {
      ...
      color: "bg-[var(--drive-accent)]",
      description:
        "창업 공간 및 인프라 제공을 통한 실질적 사업 운영 지원과 네트워킹 기회 제공",
      image:
  ...
  const categories = [
    ...
    {
      name: "Government",
      count: partners.filter((p) => p.type === "Government").length,
      color: "bg-[var(--drive-secondary)]",
    },
    {
      name: "Innovation",
      count: partners.filter((p) => p.type === "Innovation").length,
      color: "bg-[var(--drive-accent)]",
    },
    {
      name: "Academic",
      count: partners.filter((p) => p.type === "Academic").length,
      color: "bg-[var(--drive-primary)]",
    },
    {
      name: "Support",
      count: partners.filter((p) => p.type.includes("Support")).length,
      color: "bg-[var(--drive-secondary)]",
    },
  ];
      ...
      <div className="min-h-screen bg-white pt-16">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                디라이브와 함께 지속가능한 미래를 만들어가는 신뢰할 수 있는
                파트너들
              </p>
            </motion.div>
          </div>
        ...
        <section className="py-16 bg-[var(--drive-light-gray)]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-2xl font-bold text-[var(--drive-dark)] mb-4">
                파트너십 현황
              </h2>
            </motion.div>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {categories.map((category, index) => (
                ...
                >
                  <Badge
                    className={`${category.color} text-white px-4 py-2 text-sm font-semibold`}
                  >
                    {category.name}{" "}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-[var(--drive-gray)] max-w-3xl mx-auto leading-relaxed">
                다양한 분야의 전문 기관들과의 협력을 통해 더 나은 서비스를
                제공합니다
              </p>
            </motion.div>
                ...
                >
                  <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full group overflow-hidden">
                    <div className="relative">
                      ...
                      <Badge
                        className={`absolute top-4 right-4 ${partner.color} text-white`}
                      >
                        {partner.category}
                      </Badge>
                    </div>
              ...
              >
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full text-center">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-xl font-bold text-[var(--drive-dark)] mb-4">
                      기술 혁신
                    </h3>
                    <p className="text-[var(--drive-gray)] leading-relaxed">
