  ...
  const leadership = [
    {
      ...
      image: "/assets/Doo.png",
      description:
        "혁신적인 기술로 지속가능한 미래를 만들어가는 비전을 가진 리더",
    },
    {
      name: "윤기창",
      role: "CTO",
      ...
      members: [
        {
          name: "김정권",
          role: "FE Developer",
          email: "wjdrnjs112987@gmail.com",
        },
        { name: "김기윤", role: "FE Developer", email: "gykim_kr@naver.com" },
        {
          name: "정종길",
          role: "BE Developer",
          email: "jonggil.jeong24@gmail.com",
        },
      ],
    },
    {
      ...
      members: [
        {
          name: "이주애",
          role: "UI/UX Designer/Performance Marketer",
          email: "ljuae0124@naver.com",
        },
                        ...
                        <div className="space-y-3 w-full">
                          ...
                          <div className="flex flex-col sm:flex-row gap-3 justify-center">
                            ...
                            >
                              ...
                              <span className="text-sm font-medium text-[var(--drive-gray)]">
                                {leader.phone}
                              </span>
                            </a>
        ...
        <section className="py-24 bg-[var(--drive-light-gray)]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-[var(--drive-gray)] max-w-3xl mx-auto leading-relaxed">
                각 분야의 전문성을 가진 팀원들이 협력하여 최고의 결과를
                만들어냅니다
              </p>
            </motion.div>
                      ...
                      <div className="space-y-4">
                        {team.members.map((member, memberIndex) => (
                          <motion.div
                            ...
                            transition={{
                              duration: 0.5,
                              delay: teamIndex * 0.2 + memberIndex * 0.1 + 0.5,
                            }}
                            viewport={{ once: true }}
                          ...
                          >
                            ...
                            <div className="text-sm text-[var(--drive-primary)] font-medium mb-1">
                              {member.role}
                            </div>
                            <a
