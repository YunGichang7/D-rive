  ...
  const services = [
    {
      ...
      description:
        "AI 기반 친환경 경로 추천으로 연비 효율성을 극대화하는 내비게이션 서비스",
      icon: Route,
      color: "bg-yellow-500",
      benefits: [
        "연비 최적화된 경로 추천",
    ...
    },
    {
      ...
      description:
        "택시, 배송, 대리운전 등 전문 운전직 종사자를 위한 특화된 운전 관리 서비스",
      icon: Star,
      color: "bg-blue-500",
      benefits: [
        "직업별 특화된 운전 패턴 분석",
    ...
    },
    {
      ...
      description:
        "실시간 운전 데이터를 바탕으로 개인화된 보험료 할인 혜택을 제공하는 서비스",
      icon: Shield,
      color: "bg-green-500",
      benefits: [
        "운전 점수별 보험료 할인",
    ...
    },
    {
      ...
      description:
        "머신러닝을 활용한 차량 부품 교체 시기 예측 및 유지보수 최적화 서비스",
      icon: TrendingUp,
      color: "bg-purple-500",
      benefits: [
        "예방적 차량 관리",
